...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/e842116ee095ee361d45ec6c4754f025', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/e842116ee095ee361d45ec6c4754f025',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "repeat": {
	            "expression": function () {return this.activity},
	            "value": "item"
	          },
	          "events": {
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.item.quotation}
	                      }
	                    }
	                  ]
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        upDataActList: function upDataActList() {
	            var _this = this;
	            var result = {};
	            var body = 'json=';
	            ...
	            if (!_this.MaxPage) {
	                _fetch2.default.FETCHPOST('getActList', body, function (res) {
	                    if (res.ok) {
	                        var data = typeof res.data == 'string' ? JSON.parse(res.data) : res.data;

	                        if (data["INFO"].code == '609') {
	                ...
	                _api2.default.TOAST('活动列表已加载完毕，暂无更多活动');
	            }
	        },
