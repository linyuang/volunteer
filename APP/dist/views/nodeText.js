...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/27c46f62e6780cde50fc4c643f599316', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/27c46f62e6780cde50fc4c643f599316',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "events": {
	        "click": function ($event) {this.pop($event)}
	      }
	    },
	    {
	      "type": "input",
	      ...
	      "events": {
	        "focus": function ($event) {this.infocus($event)},
	        "blur": function ($event) {this.inBlur($event)}
	      }
	    }
	  ]
	}
	...
	module.exports = {
	    ...
	    methods: {
	        getData: function getData() {
	            ...
	            result += (0, _stringify2.default)(obj);
	            _api2.default.TIP(result);
	            _fetch2.default.FETCHPOST(result, function (res) {
	                _api2.default.TIP(res.ok + ',' + res.status + ',' + (0, _typeof3.default)(res.data) + ',' + res.data);
	                var Data = void 0;
	                if (res.ok) {
	                    Data = res.data;
	                    _this.text = Data;
	        ...
	        getInput: function getInput(obj, event) {
	            var _this = this;
	            _this[obj] = event.value;
	        },
	        infocus: function infocus(event) {
	            ...
	            _api2.default.TIP('我触发了:');
	        },
	        inBlur: function inBlur(event) {
	            var _this = this;
	            ...
	            _api2.default.TIP('失焦点,index =>');
	        },
	        allBlur: function allBlur() {
	            this.$el('last').blur();
	        },
	        pop: function pop() {
	            var Hulk = new BroadcastChannel('Avengers');
	            _router2.default.POP(function () {
	                Hulk.postMessage("Hulk Smash !!!");
	                _api2.default.TOAST('我放回都user');
	            });
	        },
	        timeStop: function timeStop() {
	            var _this = this;
	            _api2.default.SETITEM('timeOut', _this.timeOut, function (e) {
	                if (e.result == "success") {
	                    _api2.default.TOAST('我设置成功');
	                }
	            });
	        },
