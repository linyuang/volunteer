...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/7cd5c80af4dac4de2589cf908db68de6', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/7cd5c80af4dac4de2589cf908db68de6',undefined,undefined)
	    ...
	    },
	    {
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.actClick(this.item,$event)}
	              },
	              "children": [
	                {
	                  "type": "image",
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.orgClick(this.typeItem,$event)}
	          },
	          "children": [
	            {
	              "type": "div",
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.typeItem.quotation}
	                          }
	                        }
	                      ]
	                    }
	        ...
	        },
	        {
	          ...
	          "events": {
	            "loading": function ($event) {this.loading($event)}
	          },
	          "attr": {
	            "display": function () {return this.LoadingShow}
	          },
	          "children": [
	            {
	              "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var webOrg = new BroadcastChannel('WebInfo');
	module.exports = {
	    ...
	    methods: {
	        ...
	        upDataOrgList: function upDataOrgList() {
	            var _this = this;
	            var result = {};
	            var body = "json=";
	        ...
	        loading: function loading() {
	            ...
	            if (!_this.MaxPage) {
	                ...
	                _api2.default.TOAST('所有活动加载完毕，暂无更多活动');
	            }
	        },
	        orgClick: function orgClick(obj) {
	            var result = {};
	            result["type"] = 'org';
	            result["id"] = obj.id ? obj.id : '';
	            _api2.default.SETITEM('webInfo', (0, _stringify2.default)(result), function (event) {
	                if (event.result == "success") {
	                    _router2.default.PUSH('/views/webInfo', function () {});
	                }
	            });
	        },
	        actClick: function actClick(obj) {
	            var result = {};
	            result["type"] = 'act';
	            result["id"] = obj.id ? obj.id : '';
	            _api2.default.SETITEM('webInfo', (0, _stringify2.default)(result), function (event) {
