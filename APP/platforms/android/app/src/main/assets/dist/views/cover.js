...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/796ad1a0c6acb2a5db731de0cb9080fb', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/796ad1a0c6acb2a5db731de0cb9080fb',undefined,undefined)
...
/***/ function(module, exports) {
	    ...
	    fileUrl.forEach(function (item) {
	        if (url == item.name) {
	            navigator.push({
	                ...
	                modal.toast({ message: '我跳转到' + url + "页面成功" });
	                // pop();
	            });
	        }
	    });
	...
	exports.IMAGEGET = function (image) {
	    var imageUrl = 'file:///android_asset/drawable/' + image;
	    return imageUrl;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(46)(IteratorPrototype, __webpack_require__(111)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(43).Object.entries;
	  ...
	  "children": [
	    {
	      ...
	      "events": {
	        "click": function ($event) {this.push($event)}
	      },
	      "children": [
	        {
	          "type": "image",
	          ...
	          "attr": {
	            "src": function () {return this.coverImage}
	          }
	        }
	      ]
	    },
	    {
	      "type": "text",
	      "attr": {
	        "value": function () {return '我传入' + (this.num) + '个参数'}
	      }
	    },
	    {
	      "type": "text",
	      "attr": {
	        "value": function () {return 'count:' + (this.count)}
	      }
	    },
	    {
	      "type": "text",
	      "attr": {
	        "value": function () {return '函数执行了' + (this.a) + '次'}
	      }
	    }
	  ]
	}
	...
	module.exports = {
	    ...
	    methods: {
	        getImage: function getImage(image) {
	            return _router2.default.IMAGEGET(image);
	        },
	        push: function push() {
	            _router2.default.PUSH('/views/testStore');
	        },
	        setStorage: function setStorage() {
	            ...
	            _api2.default.StarStorageSet(obj);
	        },
	        getStorageData: function getStorageData(el, key) {
	            key = String(key);
	    ...
	    created: function created() {
	        var _this = this;
	        _this.coverImage = _this.getImage('cover_image.png');
	        _this.setStorage();
	    },
	    ready: function ready() {
	        var _this = this;
	        storage.getItem('yz', function (event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _entries = __webpack_require__(121);
