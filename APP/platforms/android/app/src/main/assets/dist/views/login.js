...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/74d98c15407972098a41dc153ab0005a', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/74d98c15407972098a41dc153ab0005a',undefined,undefined)
	...
	module.exports = {
	  ...
	  "children": [
	    ...
	    },
	    {
	      ...
	      "events": {
	        "click": function ($event) {this.userData($event)}
	      },
	      "children": [
	        {
	          "type": "div",
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "src": function () {return this.loginLogoImageUrl}
	              }
	            }
	          ]
	        },
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.loginTip($event)}
	              },
	              "repeat": {
	                "expression": function () {return this.LoginInput},
	                "value": "item"
	              },
	              "children": [
	                {
	                  ...
	                  "classList": function () {return ['loginInput', this.com_inputBorderColor(this.item)]},
	                  "attr": {
	                    "type": function () {return this.item.type},
	                    "placeholder": function () {return this.item.placeholder},
	                    "maxlength": "30",
	                    "value": function () {return this.item.inputValue},
	                    "disabled": function () {return this.com_disable()}
	                  },
	                  "events": {
	                    "input": function ($event) {this.Change(this.item,$event)}
	                  }
	                },
	                {
	                  "type": "text",
	                  ...
	                  "attr": {
	                    "value": function () {return this.com_errorTip(this.item)}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.toRegister($event)}
	              },
	              "children": [
	                {
	                  "type": "text",
	            ...
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.userLogin($event)}
	              },
	              "children": [
	                {
	                  "type": "text",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var login_reg = new BroadcastChannel('Register');
	var login_user = new BroadcastChannel('Login');
	module.exports = {
	    data: function () {return {
	        Head: {
	            titleText: '用户登录',
	    ...
	    methods: {
	        upData: function upData() {
	            var _this = this;
	            var loginInfo = _this.LoginInput;
	            _api2.default.GETITEM("UserInfo", function (res) {
	                if (res.result == "success") {
	                    var data = typeof res.data == 'string' ? JSON.parse(res.data) : res.data;
	                    loginInfo.forEach(function (item) {
	        ...
	        userLogin: function userLogin() {
	            ...
	            var result = {};
	            var body = 'json=';
	            var loginInfo = this.LoginInput;
	            loginInfo.forEach(function (item) {
	                result[item.id] = item.inputValue;
	            });
	            body += (0, _stringify2.default)(result);
	            _api2.default.TIP('body =>' + body);
	            _fetch2.default.FETCHPOST('login', body, function (res) {
	                _api2.default.TIP('res.ok => ' + res.ok + '');
	                var data_return = typeof res.data == 'string' ? JSON.parse(res.data) : res.data;
	                var returnUserInfo = data_return["USER"];
	                var LocalUserInfo = {};
	                if (data_return["INFO"].code == 400) {
	                    _api2.default.TIP('登录成功');
	                    ...
	                    try {
	                        for (var _iterator = (0, _getIterator3.default)((0, _entries2.default)(returnUserInfo)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                            var _step$value = (0, _slicedToArray3.default)(_step.value, 2),
	                                key = _step$value[0],
	                                value = _step$value[1];
	                    ...
	                    _api2.default.SETITEM('Login', "true", function () {});

	                    _api2.default.TIP((0, _stringify2.default)(LocalUserInfo));
	                    _api2.default.SETITEM("UserInfo", (0, _stringify2.default)(LocalUserInfo), function (event) {
	                        if (event.result == "success") {
	                    ...
	                    if (data_return["INFO"].code == 401) {
	                        _api2.default.TIP('登录失败，用户不存在');
	                    } else {
	                        if (data_return["INFO"].code == 402) {
	                            _api2.default.TIP('登录失败，密码错误');
	                        } else {
	                            if (data_return["INFO"].code == 411) {
	                                _api2.default.TIP('登录失败，该用户已被冻结');
	                            }
	                        }
	                    }
	                }
	        ...
	        Change: function Change(obj, event) {
	        ...
	        toRegister: function toRegister() {
	            _router2.default.PUSH('/views/register');
	        },
	        inputTest: function inputTest(obj) {
	        ...
	        errString: function errString(obj) {
	            var Rule = /[,#$= ]|[<].{0,1000}[>]|[\u4e00-\u9fa5]/;
	            return Rule.test(obj.inputValue);
	        },
	        inputVoidTest: function inputVoidTest() {
	            var _this = this;
	            var info = _this.LoginInput;
	        ...
	        loginTip: function loginTip() {
	            if (this.Logining) {
	                _api2.default.TOAST('正在登陆，请稍等');
	            }
	        },
	        com_disable: function com_disable() {
	            return this.Logining;
	        },
	        com_inputBorderColor: function com_inputBorderColor(obj) {
