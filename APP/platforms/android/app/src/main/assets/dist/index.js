...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weexComponents = __webpack_require__(97);

	var WeexComponents = _interopRequireWildcard(_weexComponents);
	...
	module.exports = {
	    ...
	    methods: {
	                    ...
	                    keys.forEach(function (item) {
	                        _api2.default.REMOVEITEM(item, function (res) {
	                            if (res.result == 'success') {
	                                _api2.default.STORAGELENGTH(function (res) {
	                                    if (res.result == 'success') {
	                                        if (res.data == 0) {}
	                                    }
	                                });
	        ...
	        initialData: function initialData() {
	            ...
	            try {
	                for (var _iterator = (0, _getIterator3.default)((0, _entries2.default)(_index2.default.state)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var _step$value = (0, _slicedToArray3.default)(_step.value, 2),
	                        key = _step$value[0],
	                        value = _step$value[1];

	                    _api2.default.SETITEM(key, value, function (event) {
	                        if (event.result == "success") {}
	                    });
	                }
	            } catch (err) {
